 ...
 * Replaces m3ap_decoder.h's .c: the mouse07410 asn1c output emits ANY_t for
...
int m3ap_decode_pdu(M3AP_M3AP_PDU_t *pdu, const uint8_t *const buffer, uint32_t length) { return 0; }
