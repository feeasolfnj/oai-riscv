 ...
 * Replaces m3ap_MCE_handler.h's .c: the mouse07410 asn1c output emits ANY_t for
...
int m3ap_MCE_handle_message(instance_t instance, uint32_t assoc_id, int32_t stream, const uint8_t * const data, const uint32_t data_length) { return 0; }
