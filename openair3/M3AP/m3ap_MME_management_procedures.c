 ...
 * Replaces m3ap_MME_management_procedures.h's .c: the mouse07410 asn1c output emits ANY_t for
...
m3ap_MME_instance_t *m3ap_MME_get_instance(uint8_t mod_id) { return 0; }

uint16_t m3ap_MME_fetch_add_global_cnx_id(void) { return 0; }
