                                                      ...
                                                      const uint8_t rsrp)
{
  ...
  if (bcch_message->message.present == NR_BCCH_DL_SCH_MessageType_PR_c1) {
    LOG_I(NR_RRC, "BCCH message present=%d, c1 present=%d (SIB1=%d, SI=%d)\n",
          bcch_message->message.present,
          bcch_message->message.choice.c1->present,
                                       ...
                                       long *fullConfig)
{
  ...
  // TODO: ext2 and bh_RLC_Channel* are not currently generated by asn1c
  // if(cellGroupConfig->ext2 != NULL && cellGroupConfig->bh_RLC_ChannelToReleaseList_r16 != NULL){
  //   //TODO (perform the BH RLC channel addition/modification as specified in 5.3.5.5.11)
  // }

  // if(cellGroupConfig->ext2 != NULL && cellGroupConfig->bh_RLC_ChannelToAddModList_r16 != NULL){
  //   //TODO (perform the BH RLC channel addition/modification as specified in 5.3.5.5.11)
  // }
}
